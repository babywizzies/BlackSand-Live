...
const LeifDojang = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        Sound Designer, Composer & Musician, crafting original pieces for
        BlackSand Citizens, Racers and the wider FRWC community.
      </p>
      ...
      <div className={styles.subcontainer}>
        <div className={styles.card}>
          <iframe
            width="380"
            height="215"
            src="https://www.youtube.com/embed/hSElehoZ3zc?controls=0"
        ...
        <Link href="/">
          <div className={styles.card}>
            <iframe
              width="380"
              height="215"
              src="https://player.vimeo.com/video/788867872?h=119de51e9b&title=0&byline=0"
              frameBorder="0"
            ...
            <div className={styles.subcard}>
              ...
              <p>
                Theme song based on your existing lore, that ties music and lore
                together.
              </p>
              <br />
              <b>Redeem for</b>
