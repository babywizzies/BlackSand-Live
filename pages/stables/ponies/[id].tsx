...
export const getServerSideProps: GetServerSideProps = async ({ params }) => {
  ...
  const pony = data.find((p: any) => p["Pony ID"] === parseInt(id));
  ...
  if (!treatRolls) {
    return {
      props: { pony: pony, ranking: ranking, treatRolls: null, enginePoints },
    };
  }

  return {
    props: { pony, ranking, treatRolls, enginePoints },
  };
};
            ...
            <div className={styles.subcontainer_1}>
              ...
              <div className={styles.level_exp}>
                ...
                <p className={styles.exp}>
                  Experience: {pony["Race Week Experience"]}
                </p>
              </div>
            </div>
          </div>
