...
return (
  <>
  <link rel='stylesheet' href='https://unpkg.com/boxicons@2.1.2/css/boxicons.min.css'></link>
  <link rel="stylesheet" href="https://unicons.iconscout.com/release/v4.0.0/css/line.css"></link>
    <section className={styles.section} id={styles.skills}>
        {!windowOpen && !isMinted && (
                          ...
                          {isConnected && (
                                               ...
                                               <button className={styles.mintbutton} disabled={!theMinter || isMintLoading || isMintStarted}
                                                         data-mint-loading={isMintLoading} data-mint-started={isMintStarted} onClick={() => theMinter?.()}>
                                                                 ...
                                                                 {!theMinter && isConnected && ('You are unable to mint at this time')}
